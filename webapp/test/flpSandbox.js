		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tree Table",
									"targetURL": "#globaldemotreetable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globaldemotreetable-display": {
								"semanticObject": "globaldemotreetable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=global.demo.treetable",
									"url": sap.ui.require.toUrl("global/demo/treetable")
								}
							}
						}
					}
